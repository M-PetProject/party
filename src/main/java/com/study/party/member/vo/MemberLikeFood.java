...
public class MemberLikeFood {
    ...
    @Schema(description="회원 좋아하는 음식 table 회원 idx", example="1")
    private long memberIdx;
    @Schema(description="회원 좋아하는 음식 table 음식 idx", example="1")
    private long foodIdx;
    @Schema(description="회원 좋아하는 음식 table 음식 이름", example="음식")
