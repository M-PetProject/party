...
public class NoticeController {
    ...
    public ResponseEntity<CommPaginationResVo<List<NoticeVo>>> getNotices(
        ...
        if ( team_idx < 1 ) throw new BadRequestException("올바르지 않은 정보가 전달되었습니다");
    ...
    @GetMapping("notice/{team_idx}/{notice_idx}")
    ...
    public ResponseEntity<NoticeVo> createNotice(
        ...
        if ( team_idx < 1 || isEmptyObj(noticeVo.getTitle()) || isEmptyObj(noticeVo.getContent()) ) throw new BadRequestException("필수입력값을 확인하세요");

        noticeVo.setTeamIdx(team_idx);
    ...
    @PutMapping("notice/{team_idx}/{notice_idx}")
    public ResponseEntity<NoticeVo> updateNotice(
        ...
        if ( team_idx < 1 || notice_idx < 1 || isEmptyObj(noticeVo.getTitle()) || isEmptyObj(noticeVo.getContent()) ) throw new BadRequestException("필수입력값을 확인하세요");
        ...
        noticeVo.setMemberIdx(customUserDetailsVo.getMemberIdx());
        noticeVo.setTeamIdx(team_idx);
        noticeVo.setNoticeIdx(notice_idx);
        return CommResponseVo.builder()
    ...
    @DeleteMapping("notice/{team_idx}/{notice_idx}/like")
    ...
    @PostMapping("notice/{team_idx}/{notice_idx}/unlike")
    ...
    @DeleteMapping("notice/{team_idx}/{notice_idx}/unlike")
